...
Extracts the kernel, ramdisk, second bootloader, dtb and recovery dtbo
images.
"""
...
def unpack_vendor_boot_image(args):
  ...
  info.cmdline = cstr(unpack('2048s',
                             args.boot_img.read(2048))[0].decode())
  ...
  dtb_offset = page_size * (num_boot_header_pages +
                            num_boot_ramdisk_pages
